...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29vbGJybzEyMyIsImEiOiJjbDN6YTczYTIwdHZqM3JueHR6YmV4aGN4In0.VyN8QNN8tUOCQz2TXPLNsQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/coolbro123/cl3zb5fou00br14rrnt7osnv7',
    scrollZoom: false // center: [-118.171189, 34.03414],
    // zoom: 10,
    // interactive: false,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51LBE0qIAMQqjo1kdc3Wy9QHpsvAmmAvHhhw4doPxljMsYXgPgfceVYdc1YB2dpME6E4vq4Si3FqmH0RimVDfAoH400IYLhp6mY'); // 1) Get checkout session from API
